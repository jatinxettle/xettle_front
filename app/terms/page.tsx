        ...
        <div className="pb-[7vh] text-[#3c3d40]">
          ...
          <ul className="pt-4 text-[1.1rem] list-disc pl-[1rem]">
            ...
            <li>
              ...
              document without Xettle&apos;s prior written consent.
            </li>
            <li>
          ...
          <p>
            ...
            information will be used only by Xettle for all business
            transactions that require your information to complete the
            transactions. Xettle may allow a third-party application to access
            your information in cases where a need arises for verification of
            your data and other validation purposes. Xettle ensures that
